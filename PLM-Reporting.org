...
*** Planned
- [ ] Associer le monde édité à l'exercice Editor
- [ ] Faire executer le code de la solution sur le monde
...
- Recherche d'un moyen d'envoyer le code à PLM et l'exécuter sur le monde
  que l'on édite
*** Planned
- [ ] Trouver comment envoyer le code de la solution à PLM et le faire
